...
namespace Entidade
{
    public class Conexao
    {
        ...
        public Conexao()
        {  
            sConexao = "data source=172.16.0.16\\FENIX;initial catalog=DBSAC_EMAILS;user id=db_web;password=3edc$RFV";
        ...
        //public Conexao()
        //{
        //    string path = @"C:\DADOS\Sites\S_one_Web\connection.ini";
        //    foreach (string linha in File.ReadAllLines(path))
        //    {
        //        string[] coluna = linha.Split(';');
        //        sConexao = "data source=" + coluna[0] + "\\" + coluna[1] + ";initial catalog=" + coluna[2] + ";user id=" + coluna[3] + ";password=" + coluna[4];
        //        conn = new SqlConnection(sConexao);
        //        cmd = conn.CreateCommand();
        //        cmd.CommandTimeout = 6000;
        ...
        {
            if (value is int && !((int)value).Equals(0))
            {
            ...
            if (value is decimal && !((decimal)value).Equals(0.0))
            {
                cmd.Parameters.Add(parameter, SqlDbType.Decimal);
            ...
            if (value is char && !((char)value).Equals(""))
            {
            ...
            if (value is DateTime && !((DateTime)value).Equals("") && !((DateTime)value).Equals(new DateTime(0001, 01, 01)))
            {
            ...
            if (value == null)
            {
                cmd.Parameters.Add(parameter, DBNull.Value);
